...
namespace WebsiteNoiThat.Areas.Admin.Controllers
{
    public class ProductController : HomeController
    {
...

        {
            ...
            //{
                ...
                else
                {
                    ...
                    {
                        ModelState.AddModelError("", "Chưa chọn hình ảnh sản phẩm.");
                        return View();
                    }
                    if (n.Quantity <= 0)
                    {
                    ...
                    {
                        ModelState.AddModelError("", "Ngày bắt đầu giảm giá phải trước ngày kết thúc.");
                        return View();
                    }
        ...
        public ActionResult Delete()
        {
                ...
                var model = db.Products.Find(Convert.ToInt64(productId));
                if(model != null)
                {
